        ...
        <div class="bd-example">
          <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              ...
              <img src="<?php echo get_template_directory_uri(); ?>/images/top1_1200_630.jpg" class="d-block w-100" style="background-color: #2b7b8e26" />  <!-- 絶対パスと同じ -->
                <div class="carousel-caption d-none d-md-block">
                <img src="<?php echo get_template_directory_uri(); ?>/images/logo_big_slide.png" /><!-- 絶対パスと同じ -->
              ...
              <img src="<?php echo get_template_directory_uri(); ?>/images/top2_1200_630.jpg" class="d-block w-100" /><!-- 絶対パスと同じ -->
                <div class="carousel-caption d-none d-md-block">
                <img src="<?php echo get_template_directory_uri(); ?>/images/logo_big_slide.png" /><!-- 絶対パスと同じ -->
                  <div class="title-slide">
                    <p>Samurai University</p>
                   ...
                   <div class="col-lg-3 col-md-4 col-sx-12">
                     <div class="calendar_border">
                       ...
                       <div class="calendar_month">
                            <!-- カスタムフィールドが「month」の値を取得 -->
                           <?php echo post_custom('month'); ?>
                         </div>
                         <div class="calendar_day">
                         <!-- カスタムフィールドが「day」の値を取得 -->
                         <span>
              ...
              <div class="milestones row">
                <div class="milestone col-md-3 col-lg-3 col-sx-12">
                  <div class="milestone_counter">
                    <p>教授数</p>
                    <img src="<?php echo get_template_directory_uri(); ?>/images/icon4.png" alt="" /><!-- 絶対パスと同じ -->
                ...
                <div class="milestone col-md-3 col-lg-3 col-sx-12">
                  <div class="milestone_counter">
                    <p>卒業生徒</p>
                    <img src="<?php echo get_template_directory_uri(); ?>/images/icon3.png" alt="" /><!-- 絶対パスと同じ -->
                ...
                <div class="milestone col-md-3 col-lg-3 col-sx-12">
                  <div class="milestone_counter">
                    <p>学習コース</p>
                    <img src="<?php echo get_template_directory_uri(); ?>/images/icon2.png" alt="" /><!-- 絶対パスと同じ -->
                ...
                <div class="milestone col-md-3 col-lg-3 col-sx-12">
                  <div class="milestone_counter">
                    <p>受賞</p>
                    <img src="<?php echo get_template_directory_uri(); ?>/images/icon1.png" alt="" /><!-- 絶対パスと同じ -->
